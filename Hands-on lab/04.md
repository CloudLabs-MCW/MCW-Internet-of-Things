...
> **Note**: If you are still unable to see the Windows Forms designer, close it, then right-click the **SmartMeterSimulator** project and select **Clean**. Then, right-click the project again and select **Build** and repeat step 4.
